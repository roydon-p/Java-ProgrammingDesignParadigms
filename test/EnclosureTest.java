...
public class EnclosureTest {
  ...
  /**
   * Creates instance of a new Enclosure object.
   *
   * <p>return a new instance of an Enclosure object
   */
  protected Housing housingUnit() {
    return new Enclosure(50);
  }
  ...
  public void isEnclosure() {
    assertTrue(housingUnit.isEnclosure());
  }

  @Test
  public void addOneMonkeyValidCase() {
  ...
  @Test
  public void addMoreMonkeyValidCase() {
    for (int i = 0; i < 5; i++) {
      Monkey m = new Monkey("abc", MonkeyGender.MALE, MonkeySize.LARGE, MonkeySpecies.HOWLER,
              FoodType.SEEDS, 12, 2, new Date());
      assertTrue(housingUnit.addMonkey(m));
  ...
  @Test
  public void addMoreMonkeyOverCapacityCase() {
    for (int i = 0; i < 5; i++) {
      Monkey m = new Monkey("abc", MonkeyGender.MALE, MonkeySize.LARGE, MonkeySpecies.HOWLER,
              FoodType.SEEDS, 12, 2, new Date());
  ...
  public void getValidLocation() {
    //String expected = "Enclosure: E1"; //for individual test case use this(static counter)
    String expected = "Enclosure: E8";
